...
class Register(Frame):
    ...
    def __init__(self, root,controller) -> None:
        ...
        #register page design starts here, register frames created
        ...
        #register button frame and button created
    ...
    def control_fields(self):
        ...
        #if all fields are valid, creating a new user and saving it to the database
