...
class MediaCover:
    def __init__(self,root):
        ...
        media_title=Label(media_title_frame,text="Süt İçen Kediler",font=("Roboto",9,"bold"),bg="#070F2B",fg="white")
        ...
        media_category=Label(media_category_frame,text="Belgesel",font=("Roboto",8),bg="#070F2B",fg="white")
        ...
        media_type=Label(media_type_frame,text="Film",font=("Roboto",8),bg="#070F2B",fg="white")
        ...
        media_score=Label(media_score_frame,text="4.5/5",font=("Roboto",8),bg="#070F2B",fg="white")
