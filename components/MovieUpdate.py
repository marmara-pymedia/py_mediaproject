...
class MovieUpdate:
    def __init__(self, root,controller,media) -> None:
        ...
        self.entry_movie_name.insert(0,media.title)
        ...
        self.combo_movie_type.current([category.id for category in self.category_service.get_all()].index(media.category.id))
        ...
        if media.cover_image_path is not None:
            self.cover_img_path=media.cover_image_path
        else:
        ...
        if media.bg_image_path is not None:
            self.bg_img_path=media.bg_image_path
        else:
        ...
        self.text_movie_description.insert(1.0, media.description)
