...
class UserProfile:
    ...
    def __init__(self, root) -> None:
        ...
        self.user_profile_child_frame=Frame(self.user_profile_frame,bg="white")
        self.user_profile_child_frame.pack(expand=True)

        self.user_profile_child2_frame=Frame(self.user_profile_child_frame,bg='gray')
        self.user_profile_child2_frame.pack(padx=100,pady=55,expand=True)

        self.logo_user_profile_frame=Frame(self.user_profile_child2_frame, bg="blue")
        ...
        self.label_username_get=Label(self.username_frame,text="Username Example",font=("Roboto",24))
        ...
        self.label_first_name_get=Label(self.first_name_frame,text="First Name Example",font=("Roboto",24))
        ...
        self.label_last_name_get=Label(self.last_name_frame,text="Last Name Example",font=("Roboto",24))
