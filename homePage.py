...
class HomePage(Frame):
    ...
    #Body
        ...
        self.type_filter_checkbox1=Checkbutton(self.type_filter_checkbox_frame,text="Film",font=("Roboto",12),bg="#535C91",fg="white",selectcolor="black",activebackground="#535C91",activeforeground="white")
        self.type_filter_checkbox1.grid(row=1,column=0,padx=(0,10))
        self.type_filter_checkbox2=Checkbutton(self.type_filter_checkbox_frame,text="Dizi",font=("Roboto",12),bg="#535C91",fg="white",selectcolor="black",activebackground="#535C91",activeforeground="white")
        ...
        self.category_filter_checkbox1=Checkbutton(self.category_filter_checkbox_frame,text="Belgesel",font=("Roboto",12),bg="#535C91",fg="white",selectcolor="black",activebackground="#535C91",activeforeground="white")
        self.category_filter_checkbox1.grid(row=1,column=0,sticky=W,padx=(0,10))
        self.category_filter_checkbox2=Checkbutton(self.category_filter_checkbox_frame,text="Bilim Kurgu",font=("Roboto",12),bg="#535C91",fg="white",selectcolor="black",activebackground="#535C91",activeforeground="white")
        self.category_filter_checkbox2.grid(row=1,column=1,sticky=W)
        self.category_filter_checkbox2=Checkbutton(self.category_filter_checkbox_frame,text="Gerilim",font=("Roboto",12),bg="#535C91",fg="white",selectcolor="black",activebackground="#535C91",activeforeground="white")
        self.category_filter_checkbox2.grid(row=2,column=0,sticky=W,padx=(0,10))        
        self.category_filter_checkbox2=Checkbutton(self.category_filter_checkbox_frame,text="Macera",font=("Roboto",12),bg="#535C91",fg="white",selectcolor="black",activebackground="#535C91",activeforeground="white")
